      ...
      <div className="max-w-7xl sm:max-w-7xl md:max-w-7xl lg:max-w-7xl xl:max-w-7xl mx-auto sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto flex flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row justify-between items-start sm:items-start md:items-center lg:items-center xl:items-center mb-6 sm:mb-8 md:mb-10 lg:mb-12 xl:mb-14 gap-4 sm:gap-6 md:gap-0 lg:gap-0 xl:gap-0">
        <div>
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-zinc-400">
            {user ? "Ini daftar link khusus punya lu." : "Menampilkan semua link."}
          </p>
        </div>
          ...
          <table className="w-full sm:w-full md:w-full lg:w-full xl:w-full text-left sm:text-left md:text-left lg:text-left xl:text-left border-collapse sm:border-collapse md:border-collapse lg:border-collapse xl:border-collapse">
            <thead>
              <tr className="bg-zinc-900 border-b border-zinc-800 text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl text-zinc-400">
                ...
                <th className="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 font-semibold sm:font-semibold md:font-semibold lg:font-semibold xl:font-semibold">Short URL</th>
                <th className="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 font-semibold sm:font-semibold md:font-semibold lg:font-semibold xl:font-semibold">Original URL</th>
                <th className="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 font-semibold sm:font-semibold md:font-semibold lg:font-semibold xl:font-semibold text-center sm:text-center md:text-center lg:text-center xl:text-center">Clicks</th>
                <th className="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 font-semibold sm:font-semibold md:font-semibold lg:font-semibold xl:font-semibold text-right sm:text-right md:text-right lg:text-right xl:text-right">Actions</th>
              </tr>
            </thead>
                    ...
                    <td className="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 align-middle sm:align-middle md:align-middle lg:align-middle xl:align-middle">
                      <div className="flex flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-col items-center sm:items-center md:items-center lg:items-center xl:items-center gap-2 sm:gap-2 md:gap-3 lg:gap-3 xl:gap-4">
                        ...
                        <button 
                          ...
                          className="text-[10px] sm:text-xs md:text-sm lg:text-sm xl:text-base text-zinc-400 hover:text-white sm:hover:text-white md:hover:text-white lg:hover:text-white xl:hover:text-white bg-zinc-800 sm:bg-zinc-800 md:bg-zinc-800 lg:bg-zinc-800 xl:bg-zinc-800 px-2 sm:px-2 md:px-3 lg:px-3 xl:px-4 py-1 sm:py-1 md:py-1.5 lg:py-1.5 xl:py-2 rounded sm:rounded md:rounded lg:rounded xl:rounded"
                        >
                          Download QR
                        </button>
                      </div>
